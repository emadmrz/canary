            ...
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td align="right"><img src="" width="80px" height="32px" style="display:block"></td>
                    </tr>
                    </tbody>
                </table>
            </td>
                    ...
                    <tr>
                        <td>
                            <table style="min-width:300px" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td style="font-family:Tahoma,Roboto-Regular,Helvetica,Arial,sans-serif;font-size:13px;color:#202020;line-height:1.5">
                                        ظاهراً شما کلمه عبور خود را فراموش کرده اید و درخواستی برای تغییر کلمه عبور داده اید. این کار بسیار ساده است، تنها کافی است بر روی لینک زیر کلیک نمایید.

                                        <br><br>
                                        <div align="center" dir="ltr">
                                            <a href="{{ url('password/reset/'.$token) }}">{{ url('password/reset/'.$token) }}</a>                                    </div>
                                    </td>
                                </tr>
                                <tr height="32px"></tr>
                                <tr>
                                    <td style="font-family:Tahoma,Roboto-Regular,Helvetica,Arial,sans-serif;font-size:13px;color:#202020;line-height:1.5">
                                        با احترام<br>تیم مدیریت کاربران Iece
                                    </td>
                                </tr>
                                <tr height="16px"></tr>
                                </tbody>
